...
const EmployeeDetailPrevious = () => {
  return (
    <div className="mx-auto my-auto p-10 overflow-x-auto">
      {/* Heading */}
      <h2 className="text-2xl font-semibold mb-4">Previous Project Details</h2>
        ...
        <table className="w-full table-fixed">
          <thead>
            <tr className="bg-gray-200">
              ...
              <th className="w-2/12 px-4 py-2">Team Lead Comment</th> 
            </tr>
          </thead>
          <tbody>
            {/* Add your data here */}
...
export default EmployeeDetailPrevious;
